...
class pj:
    ...
    def login_in(self):
        return self.s.login()
    def pingjia(self):
        url=f'http://jwzx.zjxu.edu.cn/jwglxt/xspjgl/xspj_cxXspjIndex.html?doType=query&gnmkdm=N401605&su={self.s.yhm}'
        ...
        url=f'http://jwzx.zjxu.edu.cn/jwglxt/xspjgl/xspj_cxXspjDisplay.html?gnmkdm=N401605&su={self.s.yhm}'
        ...
        for i in items:
            ...
            gaijin=''
            pingyu=''
            url=f'http://jwzx.zjxu.edu.cn/jwglxt/xspjgl/xspj_bcXspj.html?gnmkdm=N401605&su={self.s.yhm}'
        ...
        print("如果提交失败请登录http://jwzx.zjxu.edu.cn/jwglxt/xtgl/login_slogin.html手动提交")
        url='http://jwzx.zjxu.edu.cn/jwglxt/xspjgl/xspj_tjXspj.html?gnmkdm=N401605&su={self.s.yhm}'
        r=self.s.s.post(url,headers=head,data=data)
        print(r.text)
        input()
